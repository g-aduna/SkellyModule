 ...
 */
public class SkellyGatewayHook extends AbstractGatewayModuleHook {
    /**
     ...
     */
    private static final LoggerEx log = LoggerEx.newBuilder().build("sepia.skelly.SkellyGatewayHook");

    private final SkellyGatewayModule scriptModule = new SkellyGatewayModule();
    private GatewayContext gatewayContext;

    @Override
    public void setup(GatewayContext context) {
        this.gatewayContext = context;  // Constructor assignment
        log.info("Setting up Skelly module.");
    }
    ...
    public void startup(LicenseState activationState) {
        log.info("Starting Skelly Module.");
    }
    ...
    public void shutdown() {
        log.info("Shutting down Skelly Module.");
    }
    ...
    // Extending script functionallity by adding script manager from common
    @Override
